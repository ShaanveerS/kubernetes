...
* SERVE_TCP_PORT_9002 - serve TCP connections on port 9002
* SERVE_UDP_PORT_9003 - serve UDP connections on port 9003
* SERVE_TLS_PORT_9004 - serve TLS-encrypted TCP connections on port 9004
* SERVE_SCTP_PORT_9005 - serve SCTP connections on port 9005
...
func serveUDPPort(port, value string) {
	...
	for {
		...
		if _, err := sock.WriteTo([]byte(value), cliAddr); err != nil {
